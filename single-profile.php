                            ...
                            <?php
                                ...
                                <li class="flex items-center gap-3">
                                    <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full gradient-bg flex items-center justify-center">
                                        ...
                                        <form style="display:inline-block" method="post" action="<?php echo SITEURL .'live-stream/index.php?user=streamer&unique_model_id='?><?php echo isset($_GET['m_unique_id']) ? $_GET['m_unique_id'] : ''; ?>">
