...
<body class="page-template page-template-page-custom-sidebar page-template-page-custom-sidebar-php page page-id-865 custom-background">
   ...
   <div class="container-fluid">
               ...
               <header class="page-head article-header">
                  ...
                  <div class="headline-outer">
                     <h1 itemprop="headline" class="page-title entry-title">
                        <div class="prefancy fancy"><span>New Broadcaster</span></div>
                     </h1>
                  </div>
                  ...
                  <option value="No">No</option>
                           ...
                           <fieldset class="vfb-fieldset vfb-fieldset-2 personal-information " id="item-vfb-33">
                              ...
                              <ul class="vfb-section vfb-section-2">
                                 <li class="vfb-item vfb-item-email " id="item-vfb-30">
                                 ...
                                 <li class="vfb-item vfb-item-text vfb-left-half group-show_option" id="min_member">
                                 ...
                                 <li class="vfb-item vfb-item-text vfb-right-half group-show_option" id="t_price_mem">
                              ...
                              <div class="p-4 group-show_option">
                                 ...
                                 <table class="table assign-table">
                                    <thead class="thead-light">
                                       <tr>
                                          <th>Date</th>
                                          <th>Time</th>
                                          <th style="width:235px;">Token Price per member</th>
                                          <th style="width:40px">&nbsp;</th>
                                       </tr>
                                    </thead>
                                    <tbody class="option-list-wp files-list"></tbody>
                                 </table>
    ...
    margin-bottom: 2px;">
                           ...
                           <fieldset class="vfb-fieldset vfb-fieldset-3 short-bio " id="item-vfb-40">
                              ...
                              <ul class="vfb-section vfb-section-2">
                                 <li class="vfb-item vfb-item-date " id="item-vfb-34">
      ...
      <option value="No">No</option>
            ...
            <li class="vfb-item vfb-item-text   vfb-right-half" id="overnight">
               ...
               <input type="text" name="overnight" id="vfb-38" value="" class="vfb-text  vfb-medium  required  " />
                           ...
                           <fieldset class="vfb-fieldset vfb-fieldset-1 your-contact-details " id="item-vfb-25">
                              ...
                              <ul class="vfb-section vfb-section-1">
                                 <li class="vfb-item vfb-item-text " id="item-vfb-29"><!-- vfb-left-half -->
                  ...
                  <option value="No">No</option>
                           ...
                           <fieldset class="vfb-fieldset vfb-fieldset-4 stats " id="item-vfb-42">
                              ...
                              <ul class="vfb-section vfb-section-3">
                                 <li class="vfb-item vfb-item-textarea " id="item-vfb-41">
               ...
               <input type="text" name="perhourshoot" id="vfb-38" value="" class="vfb-text  vfb-medium  required  " />
                              ...
                              <div class="p-4 movie-assignment-option">
                                 ...
                                 <div class="row ">
                                    <div class="col-md-6  mb-5">
                                       ...
                                       <div class="">
                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_available[]" value="To travel" />To travel
                                          </div>
                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_available[]" value="In my city" />In my city
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6  mb-5">
                                       ...
                                       <div class="">
                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_interested[]" value="Cute & Casual" />Cute & Casual
                                          </div>

                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_interested[]" value="Lingerie/Bikini" />Lingerie/Bikini
                                          </div>

                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_interested[]" value="(Hot & Bold) Adult" />(Hot & Bold) Adult
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row ">
                                    <div class="col-md-6  mb-5">
                                       ...
                                       <div class="">
                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_comfortable_camera[]" value="Open" /> Open (With Face,Public Profile)
                                          </div>
                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_comfortable_camera[]" value="Discreet" /> Discreet (Without Face,Public Profile)
                                          </div>
                                          <div class="checkbox">
                                             <input type="checkbox" name="m_a_comfortable_camera[]" value="Show" /> Show my profile only to Modelling agencies
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6  mb-5">
                                       ...
                                       <div class="">
                                          <div class="radio">
                                             <input type="radio" name="m_a_paid" value="One Time" checked />
                                             One Time ( We will make you a one time payment. You agree to the use of the content on all platforms)
                                          </div>
                                          <div class="radio">
                                             <input type="radio" name="m_a_paid" value="Share Of Profits" /> Share of profits ( Co-Own your content with us. We share the profits from all platforms sources
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row ">
                                    <div class="col-md-6  mb-3">
                                       ...
                                       <input type="number" name="m_a_payout" value="0" min="0" class="vfb-text  vfb-medium  required  " />
                                    </div>
                                    <div class="col-md-6  mb-3">
         ...
         <div class="col-md-4 clearfix">
            <div class="sidebar_content widget">
   ...
   <script type="text/javascript">
      ...
      $(document).on("change", "input[type=radio]", function() {
         ...
         if (modeling_porn_assignment == 'Yes') {
            $('.movie-assignment-option').show();
            $('.movie-assignment-option .required').attr('required', true);


         } else if (modeling_porn_assignment == 'No') {
            $('.movie-assignment-option').hide();
            $('.movie-assignment-option .required').attr('required', false);
         } else {
            $('.movie-assignment-option').hide();
            $('.movie-assignment-option .required').attr('required', false);
         }
   ...
   <script id="options_script" type="text/html">
      <tr class="product-item" id="i-l-%%IDS%%">
         ...
         <td><button type="button" class="btn btn-default btn-close" onclick="remove_option(%%IDS%%)"><i class="fa fa-times"></i></button></td>
      </tr>
   </script>
