                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin: 0 0 40px 0; color: #b0b0b0; font-size: 18px; font-weight: 300; text-align: center;">You're about to join something absolutely amazing! ✨</p>
                                        <!-- Divider -->
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                        ...
                                        <p style="margin: 0 0 40px 0; color: #cccccc; font-size: 16px; line-height: 1.7; text-align: center;">
                                            Woohoo! 🚀 You've just taken the first step into our exclusive world of stunning models and incredible content. We're thrilled to have you on board! To unlock your VIP access and keep your account super secure, just use the magic link below or hit that shiny verification button. Let's get this party started! 🎊
                                        </p>
                                            ...
                                            <tr>
                                                <td align="center" style="background: linear-gradient(135deg, #2d1b69 0%, #1a0d3d 100%); border: 2px solid #6a1b9a; border-radius: 16px; padding: 30px;">
                                                    ...
                                                    <p style="margin: 15px 0 0 0; color: #b0b0b0; font-size: 14px; text-align: center;">
                                                        ...
                                                        Thanks for registering with us. now you can explore the new models and influencers. Now you can able to add coins in account and then you will free to see all images from model's. 
