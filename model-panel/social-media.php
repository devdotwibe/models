...
Welcome <?php //echo $_SESSION["log_user"]; ?>,
              ...
              <div class="headline-outer col-md-12 col-xs-12 col-sm-12 clearfix">
                <h4 class="page-title entry-title" itemprop="headline">
                  <div class="prefancy fancy"><span>Instagram and Snapchat</span></div>
                </h4>
              </div>
              <span id="state"></span>    
              <form action="act-social-media.php" method="post" enctype="multipart/form-data" class="rr_review_form" >
                ...
                <table class="form_table">
                  <tr class="rr_form_row">
                    ...
                    <td class="rr_form_input">
                      ...
                      <input class="rr_small_input" type="text" name="i_username" placeholder="" value="" required />
                    </td>
                  </tr>
                  <tr class="rr_form_row">
                    <td class="rr_form_heading rr_required" >
                    ...
                    <td class="rr_form_input">
                      <span class="form-err"></span>   
                       <input class="rr_small_input" type="text" name="i_plink" placeholder="" value=""   required />
                    </td>
                  </tr>
                  <tr class="rr_form_row">
                    <td class="rr_form_heading rr_required" >
                    ...
                    <td class="rr_form_input">
                      <span class="form-err"></span>     
                      <input class="rr_small_input" type="text" name="s_username" placeholder="" value="" required />
                    </td>
                  </tr>
                  <tr class="rr_form_row">
                    <td class="rr_form_heading rr_required" >
                    ...
                    <td class="rr_form_input">
                      <span class="form-err"></span>
                      <input class="rr_small_input" type="text" name="s_plink" placeholder="" value="" required />
                    </td>
                  </tr>
