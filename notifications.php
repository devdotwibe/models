...
<meta property="og:title" content="Notifications | The Live Models">
...
<meta name="twitter:title" content="Notifications | The Live Models">
            ...
            <div class="notification-card ultra-glass p-6 rounded-2xl border border-white/10 all <?php if($rowesdw['notification_type'] == 'gift'){ echo 'tip'; }else echo $rowesdw['notification_type'];  ?>">
                <div class="flex items-start space-x-4">
                    <div class="flex-shrink-0">
                        <img src="<?= SITEURL . $profilepic; ?>" alt="<?php echo $modalname; ?>." class="w-12 h-12 rounded-full object-cover border-2 border-purple-500">
