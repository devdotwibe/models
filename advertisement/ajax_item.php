                ...
                <div class="grid grid-cols-12 gap-4 items-center">
                    ...
                    <div class="col-span-2">
                        <div class="flex space-x-2">
                            <button class="btn-success px-4 py-2 rounded-lg text-white text-sm font-semibold" onclick="window.location='<?= SITEURL . 'advertisement/edit?id=' . $set_data['id'] ?>'">Edit</button>
                            <button class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-white text-sm font-semibold" onclick="window.location='<?= SITEURL . 'advertisements/view?id=' . $set_data['id'] ?>'">View</button>
                            <button class="btn-warning px-4 py-2 rounded-lg text-white text-sm font-semibold" onclick="window.location='<?= SITEURL . 'boost-advertisement?id=' . $set_data['id'] ?>'">Promote</button>
