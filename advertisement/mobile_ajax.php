        ...
        <div class="max-w-3xl mx-auto mt-10 rounded-xl bg-[#131a2a] p-6 shadow-lg" id="adv_row_mob_<?= $set_data['id'] ?>">
            ...
            <div class="grid grid-cols-12 gap-4 items-center mob1 mob2">
                ...
                <div class="col-span-3">
                    ...
                    <span class="inline-block bg-yellow-400 text-black font-semibold text-sm px-3 py-1 rounded-md mt-2 status-<?php if (empty($set_data['adv_status'])) { echo 'Active'; }else{ echo $set_data['adv_status'];  }  ?> ">
                        <?= $status ?>
                    </span>
                </div>
