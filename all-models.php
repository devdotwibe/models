                ...
                $userDetails = [];
                    ...
                    if (isset($_POST['filter_submit'])) {
                        ...
                        if (empty($onlineUserIds)) {
                            ...
                            $sqls = "SELECT * FROM model_user mu WHERE mu.verified = '1'   AND mu.id IN ($idList)  AND mu.id  IN ($basicList) $where  $order LIMIT $limit OFFSET $offset";
                ...
                <div class="filter-section">
                    ...
                    <div class="filter-group">
                        ...
                        <select class="filter-select" id="genderFilter" name="f_gender">
                            <option value="Male" <?php if (!isset($_POST['f_gender']) || (isset($_POST['f_gender']) && $_POST['f_gender'] == 'Male')) {
                                                        echo 'selected';
                                                    } ?>>Male</option>
                            <option value="Female" <?php if ((isset($_POST['f_gender']) && $_POST['f_gender'] == 'Female')) {
                                                        echo 'selected';
                                                    } ?>>Female</option>
                            <option value="Transgender" <?php if ((isset($_POST['f_gender']) && $_POST['f_gender'] == 'Transgender')) {
                                                            echo 'selected';
                                                        } ?>>Transgender</option>
                            <option value="any" <?php if ((isset($_POST['f_gender']) && $_POST['f_gender'] == 'any')) {
                                                    echo 'selected';
                                                } ?>>Any</option>
                        </select>
                    </div>
                ...
                <div class="filter-section <?php if (!$user_have_preminum) {
                    ...
                    <div class="filter-group">
                        ...
                        <select class="filter-select" id="bodyTypeFilter" name="f_body_type">
                            <option value="any" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'any') {
                                                    echo 'selected';
                                                } ?>>Any</option>
                            <option value="Petite" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'Petite') {
                                                        echo 'selected';
                                                    } ?>>Petite</option>
                            <option value="Slim" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'Slim') {
                                                        echo 'selected';
                                                    } ?>>Slim</option>
                            <option value="Athletic" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'Athletic') {
                                                            echo 'selected';
                                                        } ?>>Athletic</option>
                            <option value="Average" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'Average') {
                                                        echo 'selected';
                                                    } ?>>Average</option>
                            <option value="Curvy" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'Curvy') {
                                                        echo 'selected';
                                                    } ?>>Curvy</option>
                            <option value="Full Figured" <?php if (isset($_POST['f_body_type']) && $_POST['f_body_type'] == 'Full Figured') {
                                                                echo 'selected';
                                                            } ?>>Full Figured</option>
                        </select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <select class="filter-select" id="ethnicityFilter" name="f_ethnicity">
                            <option value="any" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'any') {
                                                    echo 'selected';
                                                } ?>>Any</option>
                            <option value="asian" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'asian') {
                                                        echo 'selected';
                                                    } ?>>Asian</option>
                            <option value="black" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'black') {
                                                        echo 'selected';
                                                    } ?>>Black</option>
                            <option value="hispanic" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'hispanic') {
                                                            echo 'selected';
                                                        } ?>>Hispanic</option>
                            <option value="white" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'white') {
                                                        echo 'selected';
                                                    } ?>>White</option>
                            <option value="mixed" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'mixed') {
                                                        echo 'selected';
                                                    } ?>>Mixed</option>
                            <option value="other" <?php if (isset($_POST['f_ethnicity']) && $_POST['f_ethnicity'] == 'other') {
                                                        echo 'selected';
                                                    } ?>>Other</option>
                        </select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <select class="filter-select" id="hairColorFilter" name="f_hair_color">
                            <option value="any" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'any') {
                                                    echo 'selected';
                                                } ?>>Any</option>
                            <option value="Blonde" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Blonde') {
                                                        echo 'selected';
                                                    } ?>>Blonde</option>
                            <option value="Brunette" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Brunette') {
                                                            echo 'selected';
                                                        } ?>>Brunette</option>
                            <option value="Black" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Black') {
                                                        echo 'selected';
                                                    } ?>>Black</option>
                            <option value="Red" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Red') {
                                                    echo 'selected';
                                                } ?>>Red</option>
                            <option value="Auburn" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Auburn') {
                                                        echo 'selected';
                                                    } ?>>Auburn</option>
                            <option value="Gray" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Gray') {
                                                        echo 'selected';
                                                    } ?>>Gray</option>
                            <option value="Other" <?php if (isset($_POST['f_hair_color']) && $_POST['f_hair_color'] == 'Other') {
                                                        echo 'selected';
                                                    } ?>>Other</option>
                        </select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <select class="filter-select" id="eyeColorFilter" name="f_eye_color">
                            <option value="any" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'any') {
                                                    echo 'selected';
                                                } ?>>Any</option>
                            <option value="Brown" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'Brown') {
                                                        echo 'selected';
                                                    } ?>>Brown</option>
                            <option value="Blue" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'Blue') {
                                                        echo 'selected';
                                                    } ?>>Blue</option>
                            <option value="Green" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'Green') {
                                                        echo 'selected';
                                                    } ?>>Green</option>
                            <option value="Hazel" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'Hazel') {
                                                        echo 'selected';
                                                    } ?>>Hazel</option>
                            <option value="Gray" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'Gray') {
                                                        echo 'selected';
                                                    } ?>>Gray</option>
                            <option value="Other" <?php if (isset($_POST['f_eye_color']) && $_POST['f_eye_color'] == 'Other') {
                                                        echo 'selected';
                                                    } ?>>Other</option>
                        </select>
                    </div>
                ...
                <div class="filter-group">
                    ...
                    <div class="filter-group">
                        ...
                        <select class="filter-select" id="languageFilter" name="f_language">
                            <option value="any" <?php if (isset($_POST['f_language']) && $_POST['f_language'] == 'any') {
                                                    echo 'selected';
                                                } ?>>Any</option>
                            <option value="Native" <?php if (isset($_POST['f_language']) && $_POST['f_language'] == 'Native') {
                                                        echo 'selected';
                                                    } ?>>Native</option>
                            <option value="Fluent" <?php if (isset($_POST['f_language']) && $_POST['f_language'] == 'Fluent') {
                                                        echo 'selected';
                                                    } ?>>Fluent</option>
                            <option value="Conversational" <?php if (isset($_POST['f_language']) && $_POST['f_language'] == 'Conversational') {
                                                                echo 'selected';
                                                            } ?>>Conversational</option>
                            <option value="Basic" <?php if (isset($_POST['f_language']) && $_POST['f_language'] == 'Basic') {
                                                        echo 'selected';
                                                    } ?>>Basic</option>
                        </select>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
                ...
                function initProgressBar($wrapper) {
                    ...
                    // const minXP = (minPercent / 100) * barWidth;
                    // const maxP = (maxPercent / 100) * barWidth;

                    $minKnob.css("left", minPercent + "%");
                    $maxKnob.css("left", maxPercent + "%");
