...
<!-- Header -->
    ...
    <main class="main-content">
        <div class="container">
			...
			$sqls = "SELECT mu.* FROM model_extra_details md join model_user mu on mu.unique_id = md.unique_model_id WHERE mu.as_a_model = 'Yes' AND WHERE mu.unique_id IN ($unique_id_List) ".$where."  Order by mu.id DESC LIMIT $limit OFFSET $offset";
