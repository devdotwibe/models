...
if(!empty($row["dob"])&&$row["dob"]!='0000-00-00'){
	$dob= h_dateFormat($row["dob"],'d-m-Y');
}
...
<input type="radio" name="gender" value="Male" class="vfb-text  vfb-medium" <?=$gender=='Male'?'checked':''?> required />
</label>

<label style="padding-right: 20px;">Female
<input type="radio" name="gender" value="Female" class="vfb-text  vfb-medium" <?=$gender=='Female'?'checked':''?> required />
</label>

<label style="padding-right: 20px;">Transgender
<input type="radio" name="gender" value="Transgender" class="vfb-text  vfb-medium" <?=$gender=='Transgender'?'checked':''?> required />
</label>

<label style="padding-right: 20px;">Couple 
<input type="radio" name="gender" value="Couple" class="vfb-text  vfb-medium" <?=$gender=='Couple'?'checked':''?> required />
</label>
