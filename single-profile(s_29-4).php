...
<?php
  $sql_ap = "SELECT * FROM user_all_access WHERE model_id = '".$_GET['m_unique_id']."' AND user_id = '".$_SESSION['log_user_unique_id']."'";
    ...
    <div class="ban_img_dv">
      <div class="main_img_wdth">
        <?php
          ...
          ?>
        <img alt="modelss" alt="models" class="banner_img_dynmic" src="<?php echo $row_bi['model_banner_pic']; ?>">
        <?php }else{?>
        <img alt="modelss" class="banner_img" src="assets/images/background-992850_640.png">
        <?php }?>
        <?php 
    ...
    <div class="container">
      ...
      <div class="row menuyg">
        <div class="col-md-2 col-sm-6 col-xs-6 ">
          <div class="cir_img">
            <img  src="<?php echo $rowesdw['profile_pic']; ?>">
          </div>
          <? $session_id = $_GET['m_unique_id'];
        if($_SESSION["log_user_unique_id"]== $session_id){ ?>
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
          <div class="row">
            ...
            <br>
            <div></div>
            <button class="fancy_button" style="padding: 8px;" data-toggle="modal" data-target="#myModal_v_sf">ABOUT</button>
            <button class="fancy_button" style="padding: 8px;" data-toggle="modal" data-target="#myModal_v_faci">SERVICES</button>
            
            
            <br/><br/>
            
            <?php if($_GET['m_unique_id'] != $_SESSION["log_user_unique_id"]){ ?>
              <button class="fancy_button" style="padding: 8px;" data-toggle="modal" data-target="#all_access">ALL ACCESS (30 DAYS)</button>
            <?php } ?>
            <?php 
              if($_SESSION["log_user_unique_id"]== $session_id) { 
                ?>
      ...
      <div class="row">
        ...
        <div class="col-md-3 my_dvf" style="border:0px solid blue;">
            ...
            <div style="color:white;">
                ...
                <?php
                    ...
                    if( mysqli_num_rows( $qurdd )>0 ){
                        echo '
                        <button class="btn-primary" style="color:white; " readonly >
                            <i class="fa fa-thumbs-up" style="color:green;"></i> Liked
                        </button> | <button  class="btn-primary" onclick="share()" ><i class="fa fa-share"></i> Share</button> <br/> You &
                        ';
                    }
                    else{
                        echo '
                        <span id="likebody' .$pid .'">
                        <button class="btn-primary" style="color:white; " onclick="like( ' .$pid .' ,' .$uid .' )">
                                <i class="fa fa-thumbs-up"></i> Like
                            </button> | <button class="btn-primary" onclick="share()" ><i class="fa fa-share"></i> Share</button> <br/> 
                        </span>
                        ';
                    }
                    ...
                    echo mysqli_num_rows( $qurlike ) ." Users Liked";
          ...
          <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 20px;">
              <div class="modal-body">
                ...
                <div class="row">
                  <div class="col-md-6"><img alt="modelss" class="full_img" src="<?php echo $rowes['file']; ?>"  alt=""></div>
                  <div class="col-md-6">
        ...
        <div class="col-md-3 my_dvf" style="border:0px solid yellow;">
