...
<?php 
    ...
    $un=strtolower( $_SESSION["log_user"] );
    
    $qur=mysqli_query($con,"select * from model_user where username='$un'");
...
<?php
    $user_id = $_SESSION["log_user_id"];
      $que = mysqli_query($con ,"SELECT * FROM model_user WHERE id = '".$user_id."'");
        while($row = mysqli_fetch_array($que))
          {   
?>

<!-- Mirrored from theagency.escortthemes.com/casting/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Oct 2020 06:37:44 GMT -->
...
<link rel="https://api.w.org/" href="assets/wp-content/index.html" /><link rel="alternate" type="application/json" href="assets/wp-content/wp/v2/pages/865.json" /><link rel='shortlink' href='../index2d45.html?p=865' />
<link rel="alternate" type="application/json+oembed" href="assets/wp-content/oembed/1.0/embed11bb.json?url=http%3A%2F%2Ftheagency.escortthemes.com%2Fcasting%2F" />
<link rel="alternate" type="text/xml+oembed" href="assets/wp-content/oembed/1.0/embed524a?url=http%3A%2F%2Ftheagency.escortthemes.com%2Fcasting%2F&amp;format=xml" />
...
<div id="vfb-form-3" class="visual-form-builder-container">
         ...
         <form method="post" action="act-edit-profile.php"  enctype="multipart/form-data">
           <ul class="vfb-section vfb-section-1">
              <li class="vfb-item vfb-item-text   vfb-left-half" id="item-vfb-29"><label for="vfb-29" class="vfb-desc">Name  <span class="vfb-required-asterisk">*</span></label>
                  <input type="text" name="name" id="vfb-29" value="<?php echo $name; ?>" class="vfb-text  vfb-medium" required />
               </li>
              <li class="vfb-item vfb-item-text   vfb-left-half" id="item-vfb-29">
                <label for="vfb-29" class="vfb-desc">Gender  <span class="vfb-required-asterisk">*</span></label>
                  ...
                  <input type="radio" name="gender" id="vfb-29" value="Male" checked="checked" class="vfb-text  vfb-medium" checked required /></label>
                <label style="padding-right: 20px;">Female<input type="radio" name="gender" id="vfb-29" value="Female" class="vfb-text  vfb-medium" required /></label>
                 <label style="padding-right: 20px;">Couple <input type="radio" name="gender" id="vfb-29" value="Couple" class="vfb-text  vfb-medium" required /></label>
                 <?php }elseif($gender == 'Female'){ ?>
                  <label style="padding-right: 20px;">Male<input type="radio" name="gender"  id="vfb-29" value="Male" class="vfb-text  vfb-medium" required /></label>
                   <label style="padding-right: 20px;">Female<input type="radio" name="gender" checked="checked" id="vfb-29" value="Female" class="vfb-text  vfb-medium" checked required /></label>
                   <label style="padding-right: 20px;">Couple<input type="radio" name="gender"  id="vfb-29" value="Couple" class="vfb-text  vfb-medium" required /></label>

                   <?php }elseif($gender == 'Couple'){ ?>
                  <label style="padding-right: 20px;">Male<input type="radio" name="gender"  id="vfb-29" value="Male" class="vfb-text  vfb-medium" required /></label>
                   <label style="padding-right: 20px;">Female<input type="radio" name="gender"  id="vfb-29" value="Female" class="vfb-text  vfb-medium" required /></label>
                   <label style="padding-right: 20px;">Couple<input checked type="radio" name="gender" checked="checked"  id="vfb-29" value="Couple" class="vfb-text  vfb-medium" required /></label>
                   <?php }else{ ?>
                 <label style="padding-right: 20px;">Male<input type="radio" name="gender"  id="vfb-29" value="Male" class="vfb-text  vfb-medium" required /></label>
                   <label style="padding-right: 20px;">Female<input type="radio" name="gender" id="vfb-29" value="Female" class="vfb-text  vfb-medium" required /></label>
                   <label style="padding-right: 20px;">Couple<input type="radio" name="gender"  id="vfb-29" value="Couple" class="vfb-text  vfb-medium" required /></label>
              ...
              <input type="hidden" name="use_id" value="<?php echo $_SESSION["log_user_id"]; ?>">
               <li class="vfb-item vfb-item-email   vfb-right-half" id="item-vfb-30"><label for="vfb-30" class="vfb-desc">Country <span class="vfb-required-asterisk">*</span></label>
                   <input type="text" value="<?php echo $country; ?>" name="country" id="vfb-30" value="" class="vfb-text  vfb-medium email " required/>
               </li>
                <li class="vfb-item vfb-item-email   vfb-right-half" id="item-vfb-30"><label for="vfb-30" class="vfb-desc">City <span class="vfb-required-asterisk">*</span></label>
                    <input type="text" value="<?php echo $city; ?>" name="city" id="vfb-30" value="" class="vfb-text  vfb-medium email " required/>
               </li>
                <li class="vfb-item vfb-item-submit" id="item-vfb-28">
      ...
      <fieldset class="vfb-fieldset vfb-fieldset-2 personal-information " id="item-vfb-33">
         ...
         <ul class="vfb-section vfb-section-2">
            <li class="vfb-item vfb-item-text   vfb-left-half" id="item-vfb-29"><label for="vfb-29" class="vfb-desc">Username  <span class="vfb-required-asterisk">*</span></label><input type="text" value="<?php echo $username; ?>" name="username" id="vfb-29" readonly class="vfb-text  vfb-medium" required /></li>
           
           <li class="vfb-item vfb-item-email   vfb-right-half" id="item-vfb-30"><label for="vfb-30" class="vfb-desc">Your Email  <span class="vfb-required-asterisk">*</span></label><input type="email"  value="<?php echo $email; ?>" name="email" id="vfb-30" readonly class="vfb-text  vfb-medium  required" required /></li>
