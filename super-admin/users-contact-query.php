                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span style="cursor:pointer;"  class="btn btn-success" data-toggle="modal" data-target="#exampleModalmail<?php echo $rowesdw['user_unique_id']; ?>">Reply</span>
                          </td>
                          </form>

                          <!-- model- togle -->
                           <div class="modal fade" id="exampleModalmail<?php echo $rowesdw['user_unique_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"      aria-hidden="true">
                                ...
                                <div class="modal-header">
                                  ...
                                  <div class="modal-body">
                                    <form method="post" action="query-reply.php">
                                      <input type="hidden" name="user_unique_id" value="<?php echo $rowesdw['user_unique_id']; ?>">
