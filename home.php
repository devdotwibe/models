...
<?php include('includes/head.php'); ?>
  ...
  <div class="particles" id="particles"></div>
	...
	<?php } ?>
<main class="home-page" id="home">    <!-- Ultra Premium Hero Section with Side-by-Side Layout -->
        ...
        <div class="container mx-auto">
			...
			?>
                ...
                <div class="model-card rounded-2xl overflow-hidden hover-lift"  >
                    ...
                    <div class="mod-card-content flex flex-col" onclick="window.location.href='<?php echo SITEURL; ?>single-profile/<?php echo urlencode($rowesdw['username']); ?>'" >
                        ...
                        <div class="flex-1 mb-6">
                            <p class="text-white/70 text-base description-text" data-full-text="Let me be your escape from reality. I promise an unforgettable experience that will leave you wanting more and more. Every moment with me is crafted to perfection.">
                                ...
                                <button  onclick="window.location.href='<?php echo SITEURL; ?>single-profile/<?php echo urlencode($rowesdw['username']); ?>'"  class="read-more-btn text-indigo-400 hover:text-indigo-300 ml-2 text-sm font-medium hidden" >Read more</button>
                            </p>
                        </div>
						<?php } ?>
        ...
        <div class="container mx-auto relative z-10">
            <div class="text-center text-white">
                ...
                <div class="ul-premiumdiv flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                    ...
                    <button class="px-12 py-5 bg-white-n text-indigo-600 font-bold rounded-xl hover:bg-gray-100 transition duration-300 shadow-2xl text-xl hover-lift" <?php //if (!isset($_SESSION["log_user_id"])) { ?>   onclick="window.scrollTo({ top: 0, behavior: 'smooth' });" <?php //}?>>
