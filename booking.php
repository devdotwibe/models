...
<body class="min-h-screen text-white booking-form text-white socialwall-page enhanced5">
    ...
    <main>
        ...
        <section class="py-8 relative book-status">
                    ...
                    <?php if (isset($_GET['service'])) { ?>
                        ...
                        <div class="ultra-glass p-10 rounded-3xl shadow-2xl hover-lift book-data">
                            ...
                            <?php if ($_GET['type'] == 'collaboration') { ?>
                                ...
                                <div>
                                    <div class="block text-white/80 font-semibold mb-3 text-lg">Per Hour Rate: <?php if (!empty($extra_details)) echo $extra_details['collab_hour']; ?></div>
                                    <div class="block text-white/80 font-semibold mb-3 text-lg">Per Day Rate: <?php if (!empty($extra_details)) echo $extra_details['collab_day']; ?></div>
                                    <div class="block text-white/80 font-semibold mb-3 text-lg">Weekend Rate: <?php if (!empty($extra_details)) echo $extra_details['collab_week']; ?></div>
