...
<head>
  ...
  <link rel="alternate" type="application/json" href="assets/wp-json/wp/v2/pages/311.json" />
    ...
    <div id="content" class="clearfix row">
        ...
        <article id="post-311" class="clearfix post-311 page type-page status-publish hentry" role="article" itemscope itemtype="https://schema.org/BlogPosting">
          ...
          <header class="page-head article-header">
            ...
            <div class="headline-outer">
              <h1 itemprop="headline" class="page-title entry-title">
                <div class="prefancy fancy"><span>Booking</span></div>
              </h1>
            </div>
          ...
          <section class="page-content entry-content clearfix" itemprop="articleBody">
            <div class="artivle-body-bg">
              ...
              <p>Create unlimited custom forms for booking, casting, contact, and anything else you need.</p>
              <div id="vfb-form-1" class="visual-form-builder-container">
                <form id="booking-1" class="visual-form-builder vfb-form-1" action="act_model_booking.php" method="post" enctype="multipart/form-data">
                  ...
                  <fieldset class="vfb-fieldset vfb-fieldset-2 appointment" id="item-vfb-9">
                    ...
                    <ul class="vfb-section vfb-section-2">
                      <li class="vfb-item vfb-item-text vfb-left-half" id="item-vfb-10">
                        <label for="vfb-10" class="vfb-desc">Model Name(s) <span class="vfb-required-asterisk">*</span></label><input type="text" name="model_name" id="vfb-10" value="" class="vfb-text vfb-medium required" />
                      </li>
                      ...
                      <li class="vfb-item vfb-item-date vfb-left-half" id="item-vfb-12">
                        ...
                        <input type="date" name="meeting_date" id="vfb-12" value="" class="vfb-text vfb-date-picker vfb-medium required" data-dp-dateFormat="mm/dd/yy" />
                      </li>
                      <li class="vfb-item vfb-item-time vfb-right-half" id="item-vfb-13">
                        ...
                        <span class="vfb-time">
                          <select name="meeting_time" id="vfb-13-hour" class="vfb-select required">
                        ...
                        <span class="vfb-time">
                          <select name="meeting_time" id="vfb-13-min" class="vfb-select required">
                        ...
                        <span class="vfb-time">
                          <select name="vfb-13[ampm]" id="vfb-13-ampm" class="vfb-select required">
                  ...
                  <input type="submit" name="submit" id="vfb-4" value="Submit" class="vfb-submit " />
                  </li>
                  </ul>
                  </fieldset><input type="hidden" name="_wp_http_referer" value="/booking/" />
                </form>
      ...
      <div id="sidebar" class="pull-right col-xs-12 col-md-4">
        ...
        <div id="search-1" class="widget widget_search">
          <form action="assets/" method="get" class="form-inline">
            <fieldset>
          ...
          <div class="textwidget">
                ...
                <div id="ccr-testimonials-carousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="item active">
                      <div class="ccr-tfix">
                        <div class="testimonial-content">
                          <p>Praesent sed purus eros. Mauris mauris leo, dignissim quis porttitor commodo, scelerisque a est.&hellip;</p>
                        </div>
                      </div>
                      <div class="testimonial-meta">
                        <div class="client-photo">
                          <img width="100" height="100" src="assets/wp-content/uploads/2014/07/t4.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" loading="lazy" srcset="assets/wp-content/uploads/2014/07/t4.jpg 100w, assets/wp-content/uploads/2014/07/t4-48x48.jpg 48w" sizes="(max-width: 100px) 100vw, 100px" />
                        </div>
                        <div class="client-info">
                          <p class="client-name">
                            Joe </p>
                          <p class="client-link"><a href="javascript:;" title="">Read All Testimonials</a></p>
                        </div>
                        <div class="clear"></div>
                      </div>
                    </div>
                    ...
                    <div class="item ">
                      <div class="ccr-tfix">
                        <div class="testimonial-content">
                          <p>Quisque ut eros malesuada, auctor libero at, feugiat odio. Curabitur mollis elementum dapibus. Proin&hellip;</p>
                        </div>
                      </div>
                      <div class="testimonial-meta">
                        <div class="client-photo">
                          <img width="100" height="100" src="assets/wp-content/uploads/2014/07/t3.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" loading="lazy" srcset="assets/wp-content/uploads/2014/07/t3.jpg 100w, assets/wp-content/uploads/2014/07/t3-48x48.jpg 48w" sizes="(max-width: 100px) 100vw, 100px" />
                        </div>
                        <div class="client-info">
                          <p class="client-name">
                            Frank </p>
                    ...
                    <div class="item ">
                      <div class="ccr-tfix">
                        <div class="testimonial-content">
                          <p>Phasellus viverra risus quis augue tincidunt dapibus. Donec venenatis urna non velit tristique, eget&hellip;</p>
                        </div>
                      </div>
                      <div class="testimonial-meta">
                        <div class="client-photo">
                          <img width="100" height="100" src="assets/wp-content/uploads/2014/07/t2.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" loading="lazy" srcset="assets/wp-content/uploads/2014/07/t2.jpg 100w, assets/wp-content/uploads/2014/07/t2-48x48.jpg 48w" sizes="(max-width: 100px) 100vw, 100px" />
                        </div>
                        <div class="client-info">
                          <p class="client-name">
                            John </p>
                    ...
                    <div class="item ">
                      <div class="ccr-tfix">
                        <div class="testimonial-content">
                          <p>Nulla rutrum ut ligula in blandit. Suspendisse elit lectus.</p>
                        </div>
                      </div>
                      <div class="testimonial-meta">
                        <div class="client-photo">
                          <img width="100" height="100" src="assets/wp-content/uploads/2014/07/t1.jpg" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" loading="lazy" srcset="assets/wp-content/uploads/2014/07/t1.jpg 100w, assets/wp-content/uploads/2014/07/t1-48x48.jpg 48w" sizes="(max-width: 100px) 100vw, 100px" />
                        </div>
                        <div class="client-info">
                          <p class="client-name">
                            Ronald </p>
            ...
            <div class="headline-outer">
              <h4 class="page-title entry-title" itemprop="headline">
                <div class="prefancy fancy"><span>Featured</span></div>
              </h4>
            </div>

            <div class="wpgt-gallery">
              <div class='gallery wpgt-gallery-captions-onhover wcowlcolumns wcowlcarousel wpgt-gallery-bottomspace-default wpgt-gallery-clear'>
                <div id='gallery-1' class='owl-carousel' data-gutter-width='5' data-columns='1' data-hide-controls='false'>
                  <div class='gallery-item item gallery-item-position-1 gallery-item-attachment-858'>
                    <div class='gallery-icon portrait'><a href="javascript:;" target="_self" rel="noopener noreferrer"><img src='assets/wp-content/uploads/2014/07/suzanna-2-360x540.jpg' width='360' height='540' alt='' /></a></div>
                  ...
                  <div class='gallery-item item gallery-item-position-2 gallery-item-attachment-855'>
                    <div class='gallery-icon portrait'><a href="javascript:;" target="_self" rel="noopener noreferrer"><img src='assets/wp-content/uploads/2014/07/annabel-2-360x540.jpg' width='360' height='540' alt='' /></a></div>
                    <div class='wp-caption-text gallery-caption'>
                      <p>
                        Annabel
                      </p>
                  ...
                  <div class='gallery-item item gallery-item-position-3 gallery-item-attachment-853'>
                    <div class='gallery-icon portrait'><a href="javascript:;" target="_self" rel="noopener noreferrer"><img src='assets/wp-content/uploads/2014/07/lyndsey-3-360x540.jpg' width='360' height='540' alt='' /></a></div>
                    <div class='wp-caption-text gallery-caption'>
                      <p>
                        Lyndsey
                      </p>
                  ...
                  <div class='gallery-item item gallery-item-position-4 gallery-item-attachment-816'>
                    <div class='gallery-icon portrait'><a href="javascript:;" target="_self" rel="noopener noreferrer"><img src='assets/wp-content/uploads/2014/06/katrina-g1-360x540.jpg' width='360' height='540' alt='' /></a></div>
                    <div class='wp-caption-text gallery-caption'>
                      <p>
                        Katrina
                      </p>
                  ...
                  <div class='gallery-item item gallery-item-position-5 gallery-item-attachment-486'>
                    <div class='gallery-icon portrait'><a href="javascript:;" target="_self" rel="noopener noreferrer"><img src='assets/wp-content/uploads/2014/07/Ciara-1-360x540.jpg' width='360' height='540' alt='' /></a></div>
                    <div class='wp-caption-text gallery-caption'>
                      <p>
                        Ciara
                      </p>
                  ...
                  <div class='gallery-item item gallery-item-position-6 gallery-item-attachment-396'>
                    <div class='gallery-icon portrait'><a href="javascript:;" target="_self" rel="noopener noreferrer"><img src='assets/wp-content/uploads/2014/07/sofia-5-360x540.jpg' width='360' height='540' alt='' /></a></div>
                    <div class='wp-caption-text gallery-caption'>
                      <p>
                        Sofia
                      </p>
        ...
        <div id="tag_cloud-2" class="widget widget_tag_cloud">
          <div class="headline-outer">
            <h4 itemprop="headline" class="page-title entry-title">
              <div class="prefancy fancytw"><span>Model Tags</span></div>
            </h4>
          </div>
          <div class="tagcloud">
            <a href="javascript:;" class="tag-cloud-link tag-link-32 tag-link-position-1" style="font-size: 8pt;" aria-label="Bikini (1 item)">Bikini</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-24 tag-link-position-2" style="font-size: 8pt;" aria-label="Black and Red Lingerie (1 item)">Black and Red Lingerie</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-29 tag-link-position-3" style="font-size: 8pt;" aria-label="Black and White Lingerie (1 item)">Black and White Lingerie</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-25 tag-link-position-4" style="font-size: 14pt;" aria-label="Black Lingerie (3 items)">Black Lingerie</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-22 tag-link-position-5" style="font-size: 16pt;" aria-label="Blonde (4 items)">Blonde</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-20 tag-link-position-6" style="font-size: 22pt;" aria-label="Brunette (9 items)">Brunette</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-34 tag-link-position-7" style="font-size: 8pt;" aria-label="Ear Rings (1 item)">Ear Rings</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-35 tag-link-position-8" style="font-size: 16pt;" aria-label="Glamorous (4 items)">Glamorous</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-27 tag-link-position-9" style="font-size: 8pt;" aria-label="High Heels (1 item)">High Heels</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-28 tag-link-position-10" style="font-size: 8pt;" aria-label="Jean Shorts (1 item)">Jean Shorts</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-21 tag-link-position-11" style="font-size: 8pt;" aria-label="Lingerie (1 item)">Lingerie</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-31 tag-link-position-12" style="font-size: 8pt;" aria-label="Outside (1 item)">Outside</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-33 tag-link-position-13" style="font-size: 8pt;" aria-label="Red Negligee (1 item)">Red Negligee</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-26 tag-link-position-14" style="font-size: 11.6pt;" aria-label="Stockings (2 items)">Stockings</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-30 tag-link-position-15" style="font-size: 8pt;" aria-label="Sun Glasses (1 item)">Sun Glasses</a>
            <a href="javascript:;" class="tag-cloud-link tag-link-23 tag-link-position-16" style="font-size: 14pt;" aria-label="White Lingerie (3 items)">White Lingerie</a>
          </div>
        </div>
