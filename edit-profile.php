...
<main class="max-w-6xl mx-auto px-4 py-8">
  ...
  <form method="post" action="act-edit-profile.php" enctype="multipart/form-data" >
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="text-center">
			...
			<?php if(!empty($userDetails['profile_pic'])){
			  ...
			  <input type="file" name="pic_img" id="pic_img" class="vfb-text vfb-medium"  accept=".jpg,.jpeg,.png" />
	...
	<?php $hobbies = $userDetails['hobbies']; $hobbies = json_decode($hobbies);  ?>
      <!-- Interests & Hobbies -->
	...
	<?php $languages = $userDetails['languages'];  ?>
      ...
      <div class="languages-section lg:col-span-2">
		...
		<?php if(empty($languages)){ $lang_count = 1; ?>
		...
		<?php } $lang_count = count($languages); } ?>
        </div>
  ...
  <div id="creator-content" class="tab-content">
      ...
      <div class="collapsible-content">
        ...
        <div class="mb-6">
          ...
          <div class="radio-group mt-3">
            <div class="radio-option">
              <input type="radio" id="stream-yes" name="live_cam" value="Yes" <?php if(!empty($extra_details['live_cam']) && $extra_details['live_cam'] == 'Yes'){ echo 'checked'; } ?> onchange="toggleConditionalSection('streaming-options', true)">
              <label for="stream-yes">Yes, I'm interested</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="stream-no" name="live_cam" value="No" <?php if((!empty($extra_details['live_cam']) && $extra_details['live_cam'] == 'No') || empty($extra_details['live_cam'])){ echo 'checked'; } ?> onchange="toggleConditionalSection('streaming-options', false)">
        ...
        <div class="mt-8 mb-6">
          ...
          <div class="radio-group mt-3">
            <div class="radio-option">
              <input type="radio" id="group-yes" name="group_show" value="Yes" <?php if(!empty($extra_details['group_show']) && $extra_details['group_show'] == 'Yes'){ echo 'checked'; } ?>  onchange="toggleConditionalSection('group-options', true)">
              <label for="group-yes">Yes, sounds fun!</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="group-no" name="group_show" value="No"  <?php if((!empty($extra_details['group_show']) && $extra_details['group_show'] == 'No') || empty($extra_details['group_show'])){ echo 'checked'; } ?>  onchange="toggleConditionalSection('group-options', false)">
              <label for="group-no">Not interested</label>
            </div>
          </div>
        </div>

        <div id="group-options" class="conditional-section <?php if(!empty($extra_details['group_show']) && $extra_details['group_show'] == 'Yes'){ echo 'show'; } ?> ">
    ...
    <div id="meet-services" class="collapsible-section">
      ...
      <div class="collapsible-content">
        ...
        <div class="mb-6">
          ...
          <div class="radio-group mt-3">
            <div class="radio-option">
              <input type="radio" id="companion-yes" name="work_escort" value="Yes" <?php if(!empty($extra_details['work_escort']) && $extra_details['work_escort'] == 'Yes'){ echo 'checked'; } ?>  onchange="toggleConditionalSection('companion-options', true)">
              <label for="companion-yes">Yes, I'd love to meet people</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="companion-no" name="work_escort" value="No" <?php if((!empty($extra_details['work_escort']) && $extra_details['work_escort'] == 'No') || empty($extra_details['work_escort'])){ echo 'checked'; } ?>  onchange="toggleConditionalSection('companion-options', false)">
              <label for="companion-no">Not interested</label>
            </div>
          </div>
        </div>

        <div id="companion-options" class="conditional-section <?php if(!empty($extra_details['work_escort']) && $extra_details['work_escort'] == 'Yes'){ echo 'show'; } ?>  ">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <div class="mt-8 mb-6">
          ...
          <div class="radio-group mt-3">
            <div class="radio-option">
              <input type="radio" id="travel-yes" name="International_tours" value="Yes"  <?php if(!empty($extra_details['International_tours']) && $extra_details['International_tours'] == 'Yes'){ echo 'checked'; } ?>  onchange="toggleConditionalSection('travel-options', true)">
              <label for="travel-yes">Yes, I love to travel!</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="travel-no" name="International_tours" value="No"  <?php if((!empty($extra_details['International_tours']) && $extra_details['International_tours'] == 'No') || empty($extra_details['International_tours'])){ echo 'checked'; } ?>   onchange="toggleConditionalSection('travel-options', false)">
    ...
    <div id="content-creation" class="collapsible-section">
      ...
      <div class="collapsible-content">
        <div class="mb-6">
          ...
          <div class="radio-group mt-3">
            <div class="radio-option">
              <input type="radio" id="content-yes" name="video_pictures" value="Yes" <?php if(!empty($extra_details['video_pictures']) && $extra_details['video_pictures'] == 'Yes'){ echo 'checked'; } ?>  onchange="toggleConditionalSection('content-options', true)">
              <label for="content-yes">Yes, I'm creative!</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="content-no" name="video_pictures" value="No"  <?php if((!empty($extra_details['video_pictures']) && $extra_details['video_pictures'] == 'No') || empty($extra_details['video_pictures'])){ echo 'checked'; } ?>  onchange="toggleConditionalSection('content-options', false)">
    ...
    <div id="professional-work" class="collapsible-section">
      ...
      <div class="collapsible-content">
        ...
        <div class="mb-6">
          ...
          <div class="radio-group mt-3">
            <div class="radio-option">
              <input type="radio" id="modeling-yes" name="modeling" value="Yes" <?php if(!empty($extra_details['modeling']) && $extra_details['modeling'] == 'Yes'){ echo 'checked'; } ?>  onchange="toggleConditionalSection('modeling-options', true)">
              <label for="modeling-yes">Yes</label>
            </div>
            <div class="radio-option">
              <input type="radio" id="modeling-no" name="modeling" value="No"  <?php if((!empty($extra_details['modeling']) && $extra_details['modeling'] == 'No') || empty($extra_details['modeling'])){ echo 'checked'; } ?>  onchange="toggleConditionalSection('modeling-options', false)">
              <label for="modeling-no">No</label>
            </div>
          </div>
        </div>

        <div id="modeling-options" class="conditional-section <?php if(!empty($extra_details['modeling']) && $extra_details['modeling'] == 'Yes'){ echo 'show'; } ?> ">
          <div class="adult-section mb-6">
            ...
            <div class="mb-4">
              ...
              <div class="radio-group mt-3">
                <div class="radio-option">
                  <input type="radio" id="adult-yes" name="adult_content" value="Yes"  <?php if(!empty($extra_details['adult_content']) && $extra_details['adult_content'] == 'Yes'){ echo 'checked'; } ?>  onchange="toggleConditionalSection('adult-services', true)">
                  <label for="adult-yes">Yes, I'm comfortable</label>
                </div>
                <div class="radio-option">
                  <input type="radio" id="adult-no" name="adult_content" value="No"  <?php if((!empty($extra_details['adult_content']) && $extra_details['adult_content'] == 'No') || empty($extra_details['adult_content'])){ echo 'checked'; } ?>  onchange="toggleConditionalSection('adult-services', false)">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <div class="unit-toggle unit-toggleh" id="unit-toggleh">
              <div class="unit-option <?php if(!empty($extra_details) && $extra_details['height_type'] == 'ft'){ echo 'active'; }else if(empty($extra_details['height_type'])){ echo 'active'; } ?> ft-option" onclick="toggleHeightUnit('ft',this)">ft/in</div>
              <div class="unit-option <?php if(!empty($extra_details) && $extra_details['height_type'] == 'cm'){ echo 'active'; } ?> cm-option" onclick="toggleHeightUnit('cm',this)">cm</div>
            </div>
			...
			if($extra_details['height_type'] == 'ft' || empty($extra_details['height_type'])){
              ...
              <select class="form-select" name="feet">
                ...
                <option value="5" <?php if($feet == 5){ echo 'selected'; }else if(empty($feet)){ echo 'selected'; } ?>  >5'</option>
              ...
              <select class="form-select" name="inches" >
                ...
                <option value="6" <?php if($inches == 6){ echo 'selected'; }else if(empty($inches)){ echo 'selected'; } ?> >6"</option>
            ...
            <div id="height-cm" class="<?php if($extra_details['height_type'] == 'ft' || empty($extra_details['height_type'])) echo 'hidden'; ?>">
              <input type="number" name="height_cm" class="form-input" placeholder="Height in cm" min="140" max="200" value="<?php if($extra_details['height_type'] == 'cm') { echo $extra_details['height']; } ?>">
            </div>
			<input type="hidden" name="height_type" id="height_type" value="<?php if(empty($extra_details['height_type'])){ echo 'ft'; } else{ echo $extra_details['height_type']; } ?>">
          </div>
          <div>
            <label class="form-label">Weight</label>
            <div class="unit-toggle unit-togglew" id="unit-togglew">
              <div class="unit-option <?php if(!empty($extra_details) && $extra_details['weight_type'] == 'lbs'){ echo 'active'; }else if(empty($extra_details['weight_type'])){ echo 'active'; } ?> lbs-option" onclick="toggleWeightUnit('lbs')">lbs</div>
              <div class="unit-option <?php if(!empty($extra_details) && $extra_details['weight_type'] == 'kg'){ echo 'active'; } ?> kg-option" onclick="toggleWeightUnit('kg')">kg</div>
            </div>
			...
			<input type="hidden" name="weight_type" id="weight_type" value="<?php if(empty($extra_details['weight_type'])){ echo 'lbs'; }else { echo $extra_details['weight_type']; } ?>">
          </div>
          <div>
            <label class="form-label">Hair Color</label>
            <select class="form-select" name="hair_color" >
              <option value="">Select hair color</option>
              <option value="Blonde" <?php if($extra_details['hair_color'] == 'Blonde'){ echo 'selected'; } ?> >Blonde</option>
              <option value="Brunette" <?php if($extra_details['hair_color'] == 'Brunette'){ echo 'selected'; } ?> >Brunette</option>
              <option value="Black" <?php if($extra_details['hair_color'] == 'Black'){ echo 'selected'; } ?> >Black</option>
              <option value="Red" <?php if($extra_details['hair_color'] == 'Red'){ echo 'selected'; } ?> >Red</option>
              <option value="Auburn" <?php if($extra_details['hair_color'] == 'Auburn'){ echo 'selected'; } ?> >Auburn</option>
              <option value="Gray" <?php if($extra_details['hair_color'] == 'Gray'){ echo 'selected'; } ?> >Gray</option>
              <option value="Other" <?php if($extra_details['hair_color'] == 'Other'){ echo 'selected'; } ?> >Other</option>
            </select>
          </div>
          <div>
            ...
            <select class="form-select" name="eye_color">
              ...
              <option value="Brown" <?php if($extra_details['eye_color'] == 'Brown'){ echo 'selected'; } ?> >Brown</option>
              <option value="Blue"  <?php if($extra_details['eye_color'] == 'Blue'){ echo 'selected'; } ?> >Blue</option>
              <option value="Green" <?php if($extra_details['eye_color'] == 'Green'){ echo 'selected'; } ?> >Green</option>
              <option value="Hazel" <?php if($extra_details['eye_color'] == 'Hazel'){ echo 'selected'; } ?> >Hazel</option>
              <option value="Gray" <?php if($extra_details['eye_color'] == 'Gray'){ echo 'selected'; } ?> >Gray</option>
              <option value="Amber" <?php if($extra_details['eye_color'] == 'Amber'){ echo 'selected'; } ?> >Amber</option>
            </select>
          </div>
          <div>
          ...
          <div>
            ...
            <select class="form-select" name="body_type">
              ...
              <option value="Petite" <?php if($extra_details['body_type'] == 'Petite'){ echo 'selected'; } ?> >Petite</option>
              <option value="Slim" <?php if($extra_details['body_type'] == 'Slim'){ echo 'selected'; } ?> >Slim</option>
              <option value="Athletic" <?php if($extra_details['body_type'] == 'Athletic'){ echo 'selected'; } ?> >Athletic</option>
              <option value="Average" <?php if($extra_details['body_type'] == 'Average'){ echo 'selected'; } ?> >Average</option>
              <option value="Curvy" <?php if($extra_details['body_type'] == 'Curvy'){ echo 'selected'; } ?> >Curvy</option>
              <option value="Full Figured" <?php if($extra_details['body_type'] == 'Full Figured'){ echo 'selected'; } ?> >Full Figured</option>
            </select>
          </div>
          <div>
            ...
            <select class="form-select" name="dress_size" >
              ...
              <option value="XS (0-2)" <?php if($extra_details['dress_size'] == 'XS (0-2)'){ echo 'selected'; } ?> >XS (0-2)</option>
              <option value="S (4-6)"  <?php if($extra_details['dress_size'] == 'S (4-6)'){ echo 'selected'; } ?> >S (4-6)</option>
              <option value="M (8-10)" <?php if($extra_details['dress_size'] == 'M (8-10)'){ echo 'selected'; } ?> >M (8-10)</option>
              <option value="L (12-14)" <?php if($extra_details['dress_size'] == 'L (12-14)'){ echo 'selected'; } ?> >L (12-14)</option>
              <option value="XL (16-18)" <?php if($extra_details['dress_size'] == 'XL (16-18)'){ echo 'selected'; } ?> >XL (16-18)</option>
              <option value="XXL (20+)" <?php if($extra_details['dress_size'] == 'XXL (20+)'){ echo 'selected'; } ?> >XXL (20+)</option>
            </select>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select class="form-select" name="cup_size">
                ...
                <option value="AA" <?php if($extra_details['cup_size'] == 'AA'){ echo 'selected'; } ?> >AA</option>
                <option value="A" <?php if($extra_details['cup_size'] == 'A'){ echo 'selected'; } ?> >A</option>
                <option value="B" <?php if($extra_details['cup_size'] == 'B'){ echo 'selected'; } ?> >B</option>
                <option value="C" <?php if($extra_details['cup_size'] == 'C'){ echo 'selected'; } ?> >C</option>
                <option value="D" <?php if($extra_details['cup_size'] == 'D'){ echo 'selected'; } ?> >D</option>
                <option value="DD" <?php if($extra_details['cup_size'] == 'DD'){ echo 'selected'; } ?> >DD</option>
                <option value="DDD" <?php if($extra_details['cup_size'] == 'DDD'){ echo 'selected'; } ?> >DDD</option>
                <option value="F" <?php if($extra_details['cup_size'] == 'F'){ echo 'selected'; } ?> >F</option>
                <option value="G" <?php if($extra_details['cup_size'] == 'G'){ echo 'selected'; } ?> >G</option>
              </select>
            </div>
          </div>
        </div>
    ...
    <div class="flex justify-center mt-8">
      ...
      <button class="btn-primary text-lg px-8 py-4" type="submit" name="service_submit" onclick="saveCreatorSettings()">Save Creator Settings</button>
    </div>
	</form>
  </div>
        ...
        <div class="glass-effect p-4 rounded-lg">
          ...
          <div class="flex items-center">
            ...
            <div>
              ...
              <div class="text-sm text-white/60">$750 this month</div>
            </div>
          </div>
        </div>
        <div class="glass-effect p-4 rounded-lg">
        ...
        <div class="glass-effect p-6 rounded-xl">
          ...
          <div class="space-y-4">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex items-center">
                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-removebg-preview-dPT8gwLMmuwlVIxJWaMYzDTERZWhZB.png" alt="TLM Token" class="tlm-token mr-1">
                <span class="font-bold mr-2">4000</span>
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex items-center">
                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-removebg-preview-dPT8gwLMmuwlVIxJWaMYzDTERZWhZB.png" alt="TLM Token" class="tlm-token mr-1">
                <span class="font-bold mr-2">5000</span>
...
<script>
  ...
  function updateProfileCompletion() {
    ...
    socialLinks.forEach(input => { if (input.value) filledSocialLinks++; });
    ...
    languages.forEach(select => { if (select.value) filledLanguages++; });
