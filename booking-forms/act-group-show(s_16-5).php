...
if (isset($_POST['submit'])) {
  ...
  if($total_token < $wallet_coins){
 	  $que = "INSERT INTO `booking_group_show`(`user_unique_id`, `age`, `total_member`, `model_name`, `model_unique_id`, `duration`, `meeting_date`, `meeting_time_hour`, `meeting_time_min`, `ampm`, `instruction`,`coins`) VALUES ('".$user_unique_id."','".$age."','".$total_mem."','".$model_name."', '".$model_id."','".$duration."','".$meeting_date."','".$meeting_time_hour."','".$meeting_time_min."','".$ampm."','".$instructions."','".$total_token."')";
