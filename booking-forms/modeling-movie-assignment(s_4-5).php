            ...
            <header class="page-head article-header">
              <div class="headline-outer">
                <h1 itemprop="headline" class="page-title entry-title">
                  <div class="prefancy fancy"><span>Booking for Modeling/Movie Assignment</span></div>
                </h1>
              </div>
            </header>
            <!-- end article header -->
            <section class="page-content entry-content clearfix" itemprop="articleBody">
              <div class="artivle-body-bg">
                ...
                <div id="vfb-form-1" class="visual-form-builder-container">
                  <form class="visual-form-builder vfb-form-1" action="act-movie-assignment.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="form_id" value="1" />
                    <fieldset class="vfb-fieldset vfb-fieldset-1 your-contact-details" id="item-vfb-1">
                      <div class="vfb-legend">
                        <h3>Movie/Modeling Details</h3>
                      </div>
                      <ul class="vfb-section vfb-section-1">
                        ...
                        <li class="vfb-item vfb-item-email vfb-left-half" id="item-vfb-7">
                          <label for="vfb-7" class="vfb-desc">Duration of Movie/Modeling (In Hour)<span class="vfb-required-asterisk">*</span></label><input type="text" name="du_movie_modeling" id="vfb-7" value="" class="vfb-text vfb-medium required email" />
                        </li>
                      </ul>
                      &nbsp;
                    </fieldset>
