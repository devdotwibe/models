                  ...
                  <form id="booking-1" class="visual-form-builder vfb-form-1" action="act-group-show.php" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset class="vfb-fieldset vfb-fieldset-1 your-contact-details" id="item-vfb-1">
                      ...
                      <ul class="vfb-section vfb-section-1">
                        ...
                        <li class="vfb-item vfb-item-email vfb-left-half" id="item-vfb-7">
                          <label for="vfb-7" class="vfb-desc">Total members in group? <span class="vfb-required-asterisk">*</span></label><input type="total_mem" name="total_mem" id="vfb-7" value="" class="vfb-text vfb-medium required email" />
                        </li>
                      </ul>
                      &nbsp;
                    <!-- </fieldset> -->
                    <!-- <fieldset class="vfb-fieldset vfb-fieldset-2 appointment" id="item-vfb-9"> -->
                      ...
                      <ul class="vfb-section vfb-section-2">
                        ...
                        <li class="vfb-item vfb-item-text vfb-left-half" id="item-vfb-11">
                      ...
                      <ul class="vfb-section vfb-section-3">
                        <li class="vfb-item vfb-item-address" id="item-vfb-15">
                          <div>
                            ...
                            <span class="vfb-left">
                              <label for="vfb-15-city">City</label>
                              <input type="text" name="city" id="vfb-15-city" maxlength="150" class="vfb-text vfb-medium" />
                            </span>
                            <span class="vfb-right">
                              <label for="vfb-15-state">State / Province / Region</label>
                              <input type="text" name="state" id="vfb-15-state" maxlength="150" class="vfb-text vfb-medium" />
                            </span>
                            <span class="vfb-left">
                              <label for="vfb-15-zip">Postal / Zip Code</label>
                              <input type="text" name="zip_code" id="vfb-15-zip" maxlength="150" class="vfb-text vfb-medium" />
                            </span>
                            <span class="vfb-right">
