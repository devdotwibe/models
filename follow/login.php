...
if(isset($_POST["submitted"]) && $_POST["submitted"] == "yes")
{
	...
	$validate_user_information = mysqli_query("select * from `follow_and_unfollow_users_table` where `email` = '".mysqli_real_escape_string($user_email)."' and `password` = '".mysqli_real_escape_string($encrypted_md5_password)."'");
