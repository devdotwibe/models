...
//printR($_SERVER);die;
$activeTab = 'users_withdrow_request';
...
<div class="nk-block-between-md ">
	<div class="nk-block-head-content">
		...
		<div class="nk-block-des">
			<p>List of withdrawals in your account.</p>
		</div>
	</div>
	<div class="nk-block-head-content">
		<ul class="nk-block-tools gx-3 p-0" style="list-style:none">
			<li class="">Coins: <i class="far fa-coins" style="font-size:16px"></i> <?=$userDetails['balance']?></li>
			<li class="mt-3"><a href="<?=$m_link?>create.php" class="btn btn-primary"><span>Create Request</span></a></li>
		</ul>
	</div>
</div>
