...
if(isset($_SESSION['log_user_id'])){
	...
	if($userDetails){
		if($userDetails['balance']<=0){
			echo '<script>alert("Sorry!! You can not request.")</script>';
...
<div class="mb-3"><span style="font-size: 13px;"> </span></div>
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-12">
			...
			<div class="alert alert-info mt-3">The amount will be credited to your account within 10-14 working days. Conversion rates for currencies may vary. </div>
        </div>
    </div>
</div>
</form>
