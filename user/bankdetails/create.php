...
if(isset($_SESSION['log_user_id'])){
	...
	if($checkbankdetail){
		echo '<script>window.location.href="'.SITEURL.'user/bankdetails/edit.php"</script>';
		die;
	}
...
$f_country_list = DB::query('select id,name,sortname from countries order by name asc');
$form_data = array(
			'account_name'=>'','account_number'=>'','country'=>'','bank_name'=>'','branch_name'=>'',
			'bank_address'=>'','swift_code'=>'','account_name'=>'','account_name'=>'','account_name'=>'',
			);
?>
