      ...
      <div class="navbar navbar-default navbar-inverse navbar-right" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            if ($hShowIcon) {/*
?>
          <div class="show-mobile" ><i class="far fa-coins"></i> <?=$hCoin?></div>
<?php
*/
            }
            ?>
          ...
          <div class="navbar-collapse collapse navbar-responsive-collapse nav-width " style="float: right;">
            <ul id="menu-main-menu" class="nav navbar-nav navbar-right">
              ...
              <li id="menu-item-767" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-767 dropdown">
                <a title="Services" href="<?= SITEURL ?>services.php" data-toggle="dropdown" class="dropdown-toggle">Services <span class="caret"></span></a>
                <ul role="menu" class=" dropdown-menu">
                  <li id="menu-item-761" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-761">
                    <a title="" href="<?= SITEURL ?>services.php?type=livecam">Watch Live Models</a>
                  </li>
                  <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                    <a title="" href="<?= SITEURL ?>services.php?type=groupshow">Watch Cam Shows</a>
                  </li>
                  <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                    <a title="" href="<?= SITEURL ?>services.php?type=dating">Escorts</a>
                  </li>
                  <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                    <a title="" href="<?= SITEURL ?>services.php?type=invite">International Touring Girls</a>
                  </li>
                  <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                    <a title="" href="<?= SITEURL ?>services.php?type=content">Watch Videos and Images</a>
                  </li>
                  <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                    <a title="" href="<?= SITEURL ?>services.php?type=modeling">Modeling & Movie Assignments</a>
                  </li>
                  <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                    <a title="" href="<?= SITEURL ?>services.php?type=30days">All 30 day access</a>
                  </li>
                </ul>
              </li>
              ...
              <?php if ($_SESSION["log_user"]) { ?>
                ...
                if ($log_user_id) {
                  ...
                  $result1 = DB::queryFirstRow($sql1);
                  if ($result1) {                                
                    if ($result1['status'] == 'Published') {
                      $hBecomeModel = '';
                    } else {
                      $hBecomeModel = 'myModalfoot1';
                    }
                  } else {
                    $hBecomeModel = 'myModalfoot';
                  }
                  if ($hBecomeModel) {
                ?>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page ">
                      <a data-toggle="modal" data-target="#<?= $hBecomeModel ?>" href="javascript:;">Become a Broadcaster</a>
                    </li>
                <?php
                  }
                }
              ...
              <ul role="menu" class=" dropdown-menu">
                ...
                ?>
                <li id="menu-item-761" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-761"><a title="" href="<?= SITEURL ?>wallet.php">Wallet&nbsp;(<i class="fas fa-coins" style="font-size:15px;color:gold" aria-hidden="true"></i><?php if ($wallet_coins) {
                                                                                                                                                                                                                                                                echo $wallet_coins;
                                                                                                                                                                                                                                                              } else {
                                                                                                                                                                                                                                                                echo '0';
                                                                                                                                                                                                                                                              }  ?>)&nbsp;</a></li>
              ...
              <?php } else { ?>
                <li id="menu-item-758" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-758"><a title="Contact Us" href="<?= SITEURL ?>login.php">Sign In / Register</a></li>
              <?php } ?>
              <!-- <nav role='navigation'> -->
                ...
                <ul id="menu">
                  <?php if ($_SESSION["log_user"]) { ?>
                    ...
                    <div class="side-menu-list">
                      <hr>
                      <a href="<?= SITEURL ?>edit-profile.php">
                        <li>Edit Profile Detail</li>
                      </a>
...
<hr>
-->
                      <a href="<?= SITEURL ?>model-panel/social-media.php">
                        <li>Add Social Links</li>
                      </a>
                      <hr>
                      <a href="<?= SITEURL ?>wallet.php">
                        <li>Wallet</li>
                      </a>
                      <hr>

                      <a href="<?= SITEURL ?>dating_booking">
                        <li>Services</li>
                      </a>
                      <hr>
                      <a href="<?= SITEURL ?>advertisement/list.php">
                        <li>Advertisement</li>
                      </a>
                      <hr>
                      ...
                      <hr> -->
                      <a title="" href="<?= SITEURL ?>chat">
                        <li>Chat</li>
                      </a>
                      <hr>

                      <a href="<?= SITEURL ?>supports.php">
                        <li>Support</li>
                      </a>
                      <hr>
