...
<li class="menu-item menu-item-type-post_type menu-item-object-page ">
  <a data-toggle="modal" data-target="#<?=$hBecomeModel?>" href="javascript:;">Become a Broadcaster</a></li>
  <?php
      }
    ?>
...
-->
                      ...
                      <a title="" href="<?=SITEURL?>my-purchase.php"><li>My Purchase</li></a>
                       <hr>
                       <a title="" href="<?=SITEURL?>user/transaction-history"><li>Transaction History</li></a>
                       <hr>
<?php
if($_SESSION["user_type"] == 'Model'){
?>
<a href="<?=SITEURL?>user/withdrawal"><li>Withdrawal <!--( Connect you bank details)--></li></a>
<hr>
<?php
}
?>
                      ...
                      <hr>
                        <a title="" href="<?=SITEURL?>chat"><li>Chat</li></a>
                        <hr>
