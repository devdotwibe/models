            ...
            <li id="menu-item-767" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-767 dropdown">
                ...
                <ul role="menu" class=" dropdown-menu">
              	     <li id="menu-item-761" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-761">
                         <a title="" href="services.php?type=livecam">Watch Live Models</a>
                    </li>
              	     <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                         <a title="" href="services.php?type=groupshow">Watch Cam Shows</a>
                    </li>
                     <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                         <a title="" href="services.php?type=dating">Escorts</a>
                    </li>
                     <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                         <a title="" href="services.php?type=invite">International Touring Girls</a>
                    </li>
                     <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                         <a title="" href="services.php?type=content">Watch Videos and Images</a>
                    </li>
                     <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                         <a title="" href="services.php?type=modeling">Modeling & Movie Assignments</a>
                    </li>
                    <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763">
                         <a title="" href="services.php?type=30days">All 30 day access</a>
                    </li>
                </ul>
            </li>  
