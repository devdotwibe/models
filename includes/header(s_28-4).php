    ...
    <div class="navbar navbar-default navbar-inverse navbar-right" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <div class="logo" style="width: 710px;">
            <a href="https://thelivemodels.com/"><img src="https://thelivemodels.com/uploads/live-model-logo.png" style="    border-radius: 10px;" align="thelivemodel Logo"></a>
        ...
        <div class="navbar-collapse collapse navbar-responsive-collapse nav-width " style="float: right;">
          <ul id="menu-main-menu" class="nav navbar-nav navbar-right">
            <li id="menu-item-764" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-307 current_page_item menu-item-764 active"><a title="Home" href="https://thelivemodels.com/">Home</a></li>
            
            <li id="menu-item-759" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-759"><a title="FAQ" href="https://thelivemodels.com/all-models.php">All Models</a></li>
            ...
            <!-- <li id="menu-item-759" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-759"><a title="FAQ" href="https://thelivemodels.com/faq.php">FAQ</a></li> -->
          ...
          ?>
            ...
            <!-- <li id="menu-item-867" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-867"><a title="Casting" href="https://thelivemodels.com/model-panel/dashboard.php">Broadcast Panel</a></li> -->

          <?php }else if($status == 'No'){ ?>

            <li id="menu-item-867" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-867"><a title="Casting" href="https://thelivemodels.com/new-broadcaster.php">Become a Broadcaster</a></li>
          ...
          <?php } 
           ...
           <!--  <li id="menu-item-767" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-767 dropdown">
              ...
              <ul role="menu" class=" dropdown-menu">
		        ...
		        ?>
                <li id="menu-item-761" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-761"><a title="" href="https://thelivemodels.com/wallet.php">Wallet&nbsp;(<i class="fas fa-coins" style="font-size:15px;color:gold" aria-hidden="true"></i><?php if($wallet_coins){ echo $wallet_coins; }else{ echo '0'; }  ?>)&nbsp;</a></li>
                
                <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763"><a title="" href="https://thelivemodels.com/edit-profile.php">Edit Profile</a></li>
                <li id="menu-item-763" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-763"><a title="" href="https://thelivemodels.com/logout.php">Logout</a></li>
              </ul>
            </li>             -->

          <?php }else{ ?>
            <li id="menu-item-758" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-758"><a title="Contact Us" href="https://thelivemodels.com/login.php">Sign In</a></li>
          <?php } ?>
          <!-- <nav role='navigation'> -->
                  <div id="menuToggle" class="side-menu">
                    ...
                    <ul id="menu">
                      ...
                      <hr>
                      <a title="" href="https://thelivemodels.com/my-purchase.php"><li>My Purchase</li></a>
                       <hr>
                    ...
                    <?php }else{ ?>
                      <hr>
                      <a href="https://thelivemodels.com/all-models.php"><li>All Models</li></a>
                      <hr>
                      <a href="https://thelivemodels.com/login.php"><li>Login</li></a>
                      <hr>
                    <?php } ?>
                    </ul>
                  </div>
