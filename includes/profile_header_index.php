  ...
  <header class="glass-effect sticky top-0 z-50 border-b border-white/10">
    <div class="max-w-7xl mx-auto py-4 px-4 flex justify-between items-center">
      ...
      <div class="flex items-center space-x-4 header-desk-outer">
        <!-- Desktop Navigation -->
        <div class="hidden md:flex items-center space-x-4 header-ss header-desk-inner">
          ...
          <button onclick="window.location.href='<?= SITEURL ?>chat-app.php'; return false;" class="p-2 glass-effect rounded-full hover:bg-white/10 transition-colors relative">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
