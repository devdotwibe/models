...
<body class="enhanced5 optim-services socialwall-page">
    ...
    <?php
        ...
        {
            $model_bookings = DB::query("SELECT * FROM model_booking WHERE model_unique_id =  %s  ORDER BY id DESC", $model_unique_id);
        }
        else
        {
          $model_bookings = DB::query("SELECT * FROM model_booking WHERE user_unique_id =  %s  ORDER BY id DESC", $model_unique_id);
        }
