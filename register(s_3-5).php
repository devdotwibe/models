...
<title>Register Here | Newmodels</title>
<meta name="description" content="Register now to access the live models from around the globe. Free access to our premium features to interact, chat and meet up with the models worldwide. Register now to become a model with us. 
Register now.">
...
<!--[if IE]>
			<link rel="shortcut icon" href="https://theagency.escortthemes.com/wp-content/themes/theagency3/favicon.ico">
		<![endif]-->
...
<link rel="https://api.w.org/" href="assets/wp-json/index.html" /><link rel="alternate" type="application/json" href="assets/wp-json/wp/v2/pages/507.json" /><link rel='shortlink' href='../indexcfe8.html?p=507' />
<link rel="alternate" type="application/json+oembed" href="assets/wp-json/oembed/1.0/embedb3bd.json?url=http%3A%2F%2Ftheagency.escortthemes.com%2Fcontact-us%2F" />
<link rel="alternate" type="text/xml+oembed" href="assets/wp-json/oembed/1.0/embed7db7?url=http%3A%2F%2Ftheagency.escortthemes.com%2Fcontact-us%2F&amp;format=xml" />
              ...
              <header class="page-head article-header">
                <div class="headline-outer">
                  <h1 itemprop="headline" class="page-title entry-title">
                    <div class="prefancy fancy"><span>Register</span></div>
                  </h1>
                </div>
              </header>
              <!-- end article header -->
              <section class="page-content entry-content clearfix" itemprop="articleBody">
                <div class="artivle-body-bg">
                  <div id="vfb-form-2" class="visual-form-builder-container">
                    <form id="contact-2" class="visual-form-builder vfb-form-2 " method="post" enctype="multipart/form-data" action="act-register.php">
                      <fieldset class="vfb-fieldset vfb-fieldset-1 send-a-quick-message " id="item-vfb-17">
                        ...
                        <ul class="vfb-section vfb-section-1">
                          <li class="vfb-item vfb-item-text   vfb-left-half" id="item-vfb-21"><label for="vfb-21" class="vfb-desc">Username  <span class="vfb-required-asterisk">*</span></label>
                            <input type="text" name="username" id="vfb-21" value="" class="vfb-text  vfb-medium"   required /></li>

                          <li class="vfb-item vfb-item-email   vfb-right-half" id="item-vfb-22"><label for="vfb-22" class="vfb-desc">Your Email  <span class="vfb-required-asterisk">*</span></label>
                            <input type="email" name="email" id="vfb-22" value="" class="vfb-text  vfb-medium  email" required  /></li>

                          <li class="vfb-item vfb-item-text  vfb-left-half" id="item-vfb-24"><label for="vfb-24" class="vfb-desc">Full Name: </label>
                            <input type="text" name="name" id="vfb-24" value="" class="vfb-text  vfb-medium" required /></li>

                          <li class="vfb-item vfb-item-text  vfb-right-half" id="item-vfb-24">
                            <label for="vfb-24" class="vfb-desc">Country: </label>
                            <select name="country" class="vfb-text  vfb-medium" required style="padding: 13px;width: 100%;">
                          ...
                          <li class="vfb-item vfb-item-text  vfb-left-half" id="item-vfb-24"><label for="vfb-24" class="vfb-desc">Password: </label>
                            <input type="password" name="password" id="vfb-24" value="" class="vfb-text  vfb-medium" required /></li>

                          <li class="vfb-item vfb-item-text  vfb-right-half" id="item-vfb-24"><label for="vfb-24" class="vfb-desc">Confirm Password: </label>
                            <input type="password" name="c_password" id="vfb-24" value="" class="vfb-text  vfb-medium" required /></li>

                          <li class="vfb-item vfb-item-text  " id="item-vfb-24">
                            <input type="checkbox" name="check18plus" id="vfb-24" class="vfb-text vfb-medium" required="required" />
                            <label for="vfb-24" class="vfb-desc">By clicking "Register", you declare you are above 18+ & consent to our Terms of use, Community Guidelines and Privacy Policy including the use of cookies. </label>
                          </li>
                        <li class="vfb-item vfb-item-submit" id="item-vfb-20">
                            <input type="submit" name="vfb-submit" id="vfb-20" value="Submit" class="vfb-submit " /> &nbsp;Already Member &nbsp;<a href="login.php">&nbsp;Login Here&nbsp;</a>
                          </li>
                        </ul>
                        &nbsp;
                      </fieldset>
