...
<body>
  ...
  ?>
      ...
      <form action="" style="display:none">
        <script src="<?= 'https://checkout.razorpay.com/v1/checkout.js' ?>" data-key="rzp_test_4M7P3ViBucYNrF" data-amount="5000" data-buttontext="Pay with Razorpay" data-name="The Live Model" data-description="Test Txn with RazorPay" data-image="https://thelivemodels.com/uploads/live-model-logo.png" data-prefill.name="<?php echo $_SESSION["log_user"]; ?>" data-prefill.email="<?php echo $_SESSION["log_user_email"]; ?>" data-theme.color="#F37254">
        </script>
      </form>
  <?php
    }
